...
单元测试必须覆盖视图中心、边缘、高纬度、ERP 经线、运动历史不足、可靠预测和尺度偏差。端到端实验至少报告 BFoV spherical IoU、ERP circular IoU、中心角误差、宽高相对误差、候选排序 AUC、Brier score、`envelopeInflation`、每状态帧数和 P95 延迟。
