...
比赛 Docker 构建前运行 `.\.venv\Scripts\python.exe docker\compact_checkpoint.py`，生成小于 100 MiB 且与原权重逐张量一致的推理 checkpoint。具体流程见 [提交容器运行环境](docs/Competition/containerRuntime.md)。
